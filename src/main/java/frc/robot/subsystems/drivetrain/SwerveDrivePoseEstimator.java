...
public class SwerveDrivePoseEstimator {
  ...
  private Pose2d m_previousEstimate;
  ...
  public SwerveDrivePoseEstimator(
    ...
    m_previousEstimate = m_odometry.getPoseMeters();
  ...
  public Pose2d getEstimatedPosition(double secondsAgo) {
    var delta = new Transform2d(
        ...
        m_poseBuffer.getSample(WPIUtilJNI.now() * 1.0e-6 - secondsAgo).get()
    );
    return m_previousEstimate.transformBy(delta);
  }
  ...
  public void addVisionMeasurement(Pose2d visionRobotPoseMeters, double timestampSeconds) {
    ...
    var old = m_poseBuffer.getSample(timestampSeconds);    
    ...
    // Step 5: Apply scaled twist to the last estimated pose
    m_previousEstimate = m_previousEstimate.exp(scaledTwist);
  }
  ...
  public Pose2d updateWithTime(
    ...
    m_previousEstimate = m_previousEstimate.transformBy(new Transform2d(lastOdom, currOdom));
